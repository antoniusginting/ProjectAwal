<x-filament-panels::page>
    <div class="p-6 bg-white dark:bg-gray-900 rounded-md shadow-md">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mb-6">
            ...
            <!-- Progress Bar untuk Persentase Pembelian -->
            {{-- <div class="mt-4">
                <div class="flex justify-between items-center mb-2">
                    <span class="text-sm text-gray-600 dark:text-gray-400">Progress Pembelian Keseluruhan</span>
                    <span
                        class="text-sm font-semibold text-purple-600">{{ number_format($persenTotalPembelian, 2) }}%</span>
                </div>
                <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                    <div class="bg-gradient-to-r from-blue-500 to-purple-600 h-3 rounded-full transition-all duration-300"
                        style="width: {{ min(100, $persenTotalPembelian) }}%"></div>
                </div>
            </div> --}}
        </div>
            ...
            @foreach ($kontrakBelis as $kontrakBeli)
                <div
                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg mb-6 shadow-md border">
                        ...
                        {{-- Data Stok & Pembelian --}}
                        <div class="mb-4">
                            <h4 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Data Tonase Kontrak &
                                Pembelian
                            </h4>
                    ...
                    <div class="mb-6" id="laporan-pembelian-{{ $kontrakBeli->id }}">
                        <div class="flex justify-between items-center mb-3">
                            <div class="flex items-center gap-3">
                                <h3 class="text-lg font-semibold">Laporan Pembelian - {{ $kontrakBeli->supplier }}</h3>
                            </div>
                        </div>
                        <table class="w-full border border-collapse border-gray-300 dark:border-gray-700">
                            <thead>
