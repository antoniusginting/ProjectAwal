<x-filament-panels::page>
    <div class="p-6 bg-white dark:bg-gray-900 rounded-md shadow-md">
        <h2 class="text-2xl font-bold mb-4 text-green-600">Laporan Gabungan GORONTALO</h2>
        ...
        <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg mb-6">
            ...
            <p class="text-lg">Total Nilai Kontrak: <strong>{{ number_format($kontrakBelis->sum('stok'), 0, ',', '.') }}</strong>
            </p>
        </div>
