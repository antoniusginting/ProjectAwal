            ...
            <table class="w-full">
                <tbody class="text-base">
                    <tr>
                        ...
                        <td class="font-semibold text-left align-top whitespace-nowrap">Nama Lumbung</td>
                    ...
                    <tr>
                        ...
                        <td class="whitespace-nowrap">: {{ $penjualan->plat_polisi }}</td>
                ...
                <tbody class="text-sm">
                    <tr>
                        <td class="border p-2 text-center border-gray-300 dark:border-gray-700 whitespace-nowrap"
                            rowspan="3">
                            {{ $penjualan->no_spb }}</td>
                        <td class="border p-2 border-gray-300 dark:border-gray-700 whitespace-nowrap" rowspan="3">
                            {{ $penjualan->plat_polisi }}</td>
                        <td class="border p-2 border-gray-300 dark:border-gray-700 whitespace-nowrap" rowspan="3">
                            {{ $penjualan->nama_supir }}</td>
                        <td class="border p-2 border-gray-300 dark:border-gray-700 whitespace-nowrap" rowspan="3">
