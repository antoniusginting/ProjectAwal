...
class SuratJalanPolicy
{
    ...
    {
        return $user->can('view_any_surat::jalan');
    }
    ...
    {
        return $user->can('view_surat::jalan');
    }
    ...
    {
        return $user->can('create_surat::jalan');
    }
    ...
    {
        return $user->can('update_surat::jalan');
    }
    ...
    {
        return $user->can('delete_surat::jalan');
    }
    ...
    {
        return $user->can('delete_any_surat::jalan');
    }
