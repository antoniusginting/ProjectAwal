...
class TimbanganTrontonPolicy
{
    ...
    {
        return $user->can('view_any_timbangan::tronton');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, TimbanganTronton $timbanganTronton): bool
    {
        return $user->can('view_timbangan::tronton');
    }
    ...
    {
        return $user->can('create_timbangan::tronton');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, TimbanganTronton $timbanganTronton): bool
    {
        return $user->can('update_timbangan::tronton');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, TimbanganTronton $timbanganTronton): bool
    {
        return $user->can('delete_timbangan::tronton');
    }
    ...
    {
        return $user->can('delete_any_timbangan::tronton');
    }
