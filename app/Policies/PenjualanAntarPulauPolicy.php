...
class PenjualanAntarPulauPolicy
{
    ...
    {
        return $user->can('view_any_penjualan::antar::pulau');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, PenjualanAntarPulau $penjualanAntarPulau): bool
    {
        return $user->can('view_penjualan::antar::pulau');
    }
    ...
    {
        return $user->can('create_penjualan::antar::pulau');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, PenjualanAntarPulau $penjualanAntarPulau): bool
    {
        return $user->can('update_penjualan::antar::pulau');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, PenjualanAntarPulau $penjualanAntarPulau): bool
    {
        return $user->can('delete_penjualan::antar::pulau');
    }
    ...
    {
        return $user->can('delete_any_penjualan::antar::pulau');
    }
